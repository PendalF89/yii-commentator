...
class Comment extends \CActiveRecord
{
    ...
    public function getStatus($translate=true)
    {
        switch ($this->status)
        {
            case self::STATUS_PENDING :
                return $translate ? \Yii::t('pendalf89\yii_commentator\CommentsModule.main', 'pending') : 'pending';
            case self::STATUS_APPROVED :
                return $translate ? \Yii::t('pendalf89\yii_commentator\CommentsModule.main', 'approved') : 'approved';
            case self::STATUS_REJECTED :
                return $translate ? \Yii::t('pendalf89\yii_commentator\CommentsModule.main', 'rejected') : 'rejected';
        }
    }
    ...
    {
        return array(
            self::STATUS_PENDING => \Yii::t('pendalf89\yii_commentator\CommentsModule.main', 'pending'),
            self::STATUS_APPROVED => \Yii::t('pendalf89\yii_commentator\CommentsModule.main', 'approved'),
            self::STATUS_REJECTED => \Yii::t('pendalf89\yii_commentator\CommentsModule.main', 'rejected'),
        );
    }
    ...
    {
        return array(
            self::NOTIFY => \Yii::t('pendalf89\yii_commentator\CommentsModule.main', 'yes'),
            self::NOT_NOTIFY => \Yii::t('pendalf89\yii_commentator\CommentsModule.main', 'no'),
        );
    }
    ...
    {
        return $this->notify ? \Yii::t('pendalf89\yii_commentator\CommentsModule.main', 'yes') : \Yii::t('pendalf89\yii_commentator\CommentsModule.main', 'no');
    }
